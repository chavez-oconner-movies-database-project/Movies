...
// Function to fetch movie data from server
//     function getMovies(movieId, callback) {
//         $.ajax({
//             method: 'GET',
//             url: url + '/' + movieId,
...
//                         newEdit.replace('<h2>' + movie.title + '</h2>');
//                         newEdit.replace('<div class="rating">' + movie.rating + '</div>');
//                         newEdit.replace('<div class="director">' + movie.director + '</div>');
//                         newEdit.replace('<div class="genre">' + movie.genre + '</div>');
//
